...
class GaussianLifterV4(BaseLifter):
    def __init__(
        self,
        num_anchor,
        embed_dims,
        ...
        **kwargs,
        ...
        depth_range = kwargs.get("depth_range", [1.0, 72.0])
        self.register_buffer("depth_bins", torch.linspace(
            depth_range[0], depth_range[1], num_samples, dtype=torch.float), persistent=False)
