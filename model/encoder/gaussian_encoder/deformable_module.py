...
from ...utils.contract import contract_s2x
...
class SparseGaussian3DKeyPointsGenerator(BaseModule):
    ...
    def forward(
        ...
        if self.contracted > 0.0:
            xyz = contract_s2x(xyz * 2 - 1, self.pc_range, self.contracted)
        else:
...
class DeformableFeatureAggregation(BaseModule):
    def __init__(
        ...
        **kwargs,
        ...
        kps_generator["contracted"] = contracted
    ...
    def forward(
        ...
        **kwargs: dict,
        ...
        key_points = self.kps_generator(anchor, instance_feature + anchor_embed)
